...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { comments: @testimonial.comments, image: @testimonial.image, name: @testimonial.name, title: @testimonial.title } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { comments: @testimonial.comments, image: @testimonial.image, name: @testimonial.name, title: @testimonial.title } }
